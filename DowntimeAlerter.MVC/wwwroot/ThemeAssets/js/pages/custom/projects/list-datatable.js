...
var KTUserListDatatable = function() {
            ...
            columns: [
                {
                    ...
                    template: function(data, i) {
                        ...
                        <div class="kt-user-card-v2 kt-user-card-v2--uncircle">\
                            <div class="kt-user-card-v2__pic">\
                                <img src="assets/media/project-logos/' +
                            img +
                            '" alt="photo">\
                            </div>\
                    ...
                    template: function(row) {
                        ...
                        return '<span class="btn btn-bold btn-sm btn-font-sm ' +
    ...
    var selectedFetch = function() {
        ...
        $("#kt_datatable_records_fetch_modal").on("show.bs.modal",
            function(e) {
                // show loading dialog
                ...
                // fetch selected IDs
                var ids = datatable.rows(".kt-datatable__row--active").nodes()
    ...
    var selectedStatusUpdate = function() {
        $("#kt_subheader_group_actions_status_change").on("click",
    ...
    var selectedDelete = function() {
        $("#kt_subheader_group_actions_delete_all").on("click",
            function() {
                // fetch selected IDs
                var ids = datatable.rows(".kt-datatable__row--active").nodes()
                    .find('.kt-checkbox--single > [type="checkbox"]').map(function(i, chk) {
