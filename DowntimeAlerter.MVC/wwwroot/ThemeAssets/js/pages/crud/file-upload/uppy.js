...
var KTUppy = function() {
    ...
    var initUppy3 = function() {
        ...
        uppyDrag.on("complete",
            function(file) {
                var imagePreview = "";
                $.each(file.successful,
                    function(index, value) {
                        ...
                        imagePreview += '<div class="kt-uppy__thumbnail-container" data-id="' +
                            value.id +
                            '">' +
                            thumbnail +
                            ' <span class="kt-uppy__thumbnail-label">' +
                            value.name +
                            " (" +
                            ...
                            ')</span><span data-id="' +
                            value.id +
                            '" class="kt-uppy__remove-thumbnail"><i class="flaticon2-cancel-music"></i></span></div>';
                    });
        ...
        $(document).on("click",
            id + " .kt-uppy__thumbnails .kt-uppy__remove-thumbnail",
            function() {
    ...
    var initUppy5 = function() {
        ...
        $(id + " .uppy-FileInput-container")
            .append('<label class="kt-uppy__input-label btn btn-label-brand btn-bold btn-font-sm" for="' +
            ...
            function(file) {
                $.each(file.successful,
                    function(index, value) {
                        ...
                        var uploadListHtml = '<div class="kt-uppy__list-item" data-id="' +
                            value.id +
                            ...
                            " " +
                            sizeLabel +
                            ')</div><span class="kt-uppy__list-remove" data-id="' +
                            value.id +
        ...
        $(document).on("click",
            id + " .kt-uppy__list .kt-uppy__list-remove",
            function() {
