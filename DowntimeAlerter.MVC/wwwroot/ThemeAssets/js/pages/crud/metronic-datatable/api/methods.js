...
var KTDefaultDatatableDemo = function() {
    ...
    var demo = function() {
        ...
        $("#kt_datatable_destroy").on("click",
            function() {
                // datatable.destroy();
                $(".kt-datatable").KTDatatable("destroy");
            });

        $("#kt_datatable_init").on("click",
            function() {
        ...
        $("#kt_datatable_sort_asc").on("click",
            function() {
                datatable.sort("Status", "asc");
            });

        $("#kt_datatable_sort_desc").on("click",
            function() {
                datatable.sort("Status", "desc");
            });

        // get checked record and get value by column name
        $("#kt_datatable_get").on("click",
            function() {
                // select active rows
