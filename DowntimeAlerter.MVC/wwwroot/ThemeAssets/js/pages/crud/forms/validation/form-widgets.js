...
var KTFormWidgets = function() {
    ...
    var initWidgets = function() {
        ...
        $("[data-switch=true]").on("switchChange.bootstrapSwitch",
            function() {
        ...
        $("#kt_bootstrap_select").on("changed.bs.select",
            function() {
                validator.element($(this)); // validate element
            });
        ...
        $("#kt_typeahead").bind("typeahead:select",
