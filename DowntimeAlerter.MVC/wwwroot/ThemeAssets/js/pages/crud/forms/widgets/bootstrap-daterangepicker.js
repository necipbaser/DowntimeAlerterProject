...
var KTBootstrapDaterangepicker = function() {
    ...
    var demos = function() {
        ...
        $("#kt_daterangepicker_2").daterangepicker({
            ...
            function(start, end, label) {
                $("#kt_daterangepicker_2 .form-control")
        ...
        $("#kt_daterangepicker_3").daterangepicker({
            ...
            function(start, end, label) {
                $("#kt_daterangepicker_3 .form-control")
                    .val(start.format("YYYY-MM-DD") + " / " + end.format("YYYY-MM-DD"));
            });
        ...
        $("#kt_daterangepicker_4").daterangepicker({
            ...
            function(start, end, label) {
                $("#kt_daterangepicker_4 .form-control")
                    .val(start.format("MM/DD/YYYY h:mm A") + " / " + end.format("MM/DD/YYYY h:mm A"));
            });
        ...
        $("#kt_daterangepicker_5").daterangepicker({
            ...
            function(start, end, label) {
                $("#kt_daterangepicker_5 .form-control")
        ...
        $("#kt_daterangepicker_6").daterangepicker({
            ...
            function(start, end, label) {
                $("#kt_daterangepicker_6 .form-control")
                    .val(start.format("MM/DD/YYYY") + " / " + end.format("MM/DD/YYYY"));
            });
    };
    ...
    var validationDemos = function() {
        ...
        $("#kt_daterangepicker_1_validate").daterangepicker({
            ...
            function(start, end, label) {
                $("#kt_daterangepicker_1_validate .form-control")
                    .val(start.format("YYYY-MM-DD") + " / " + end.format("YYYY-MM-DD"));
            });
        ...
        $("#kt_daterangepicker_2_validate").daterangepicker({
            ...
            function(start, end, label) {
                $("#kt_daterangepicker_3_validate .form-control")
                    .val(start.format("YYYY-MM-DD") + " / " + end.format("YYYY-MM-DD"));
            });
