...
var KTFlotchartsDemo = function() {
    ...
    var demo3 = function() {
        ...
        $("#kt_flotcharts_3").bind("plothover",
            function(event, pos, item) {
                latestPosition = pos;
