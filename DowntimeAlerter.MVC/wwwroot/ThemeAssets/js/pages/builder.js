...
var KTLayoutBuilder = function() {
    ...
    var exporter = {
        ...
        startLoad: function(options) {
            $("#builder_export").addClass("kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light").find("span")
                .text("Exporting...").closest(".kt-form__actions").find(".btn").attr("disabled", true);
            toastr.info(options.title, options.message);
        },
        doneLoad: function() {
            $("#builder_export").removeClass("kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light")
                .find("span").text("Export").closest(".kt-form__actions").find(".btn").attr("disabled", false);
        },
                ...
                var timer = setInterval(function() {
                        $.ajax("index.php",
                            ...
                            $("<iframe/>").attr({
                                ...
                                toastr.success("Export Default Version",
    ...
    var preview = function() {
        $('[name="builder_submit"]').click(function(e) {
            e.preventDefault();
            var _self = $(this);
            $(_self).addClass("kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light")
                .closest(".kt-form__actions").find(".btn").attr("disabled", true);
    ...
    var verify = {
        reCaptchaVerified: function() {
            return $.ajax("../tools/builder/recaptcha.php?recaptcha",
                ...
                grecaptcha.reset();
                $("#alert-message").removeClass("alert-success kt-hide").addClass("alert-danger")
