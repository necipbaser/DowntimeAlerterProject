        ...
        maxlength: function(options, callback) {
            var documentBody = $("body"),
                defaults = {
                    ...
                    showCharsTyped:
                        true, // show the number of characters typed and not the number of characters remaining
                    validate:
                        false, // if the browser doesn't support the maxlength attribute, attempt to type more than
                    // the indicated chars, will be prevented.
                    utf8: false, // counts using bytesize rather than length. eg: '£' is counted as 2 characters.
                    appendToParent: false, // append the indicator to the input field's parent instead of body
                    twoCharLinebreak:
                        true, // count linebreak as 2 characters to match IE/Chrome textarea validation. As well as DB storage.
            ...
            */
            ...
            function manageRemainingVisibility(remaining, currentInput, maxLengthCurrentInput, maxLengthIndicator) {
                if (maxLengthIndicator) {
                    maxLengthIndicator.html(updateMaxLengthHTML(currentInput.val(),
                        maxLengthCurrentInput,
                        (maxLengthCurrentInput - remaining)));

                    if (remaining > 0) {
                        if (charsLeftThreshold(currentInput, options.threshold, maxLengthCurrentInput)) {
                            showRemaining(currentInput,
                                maxLengthIndicator.removeClass(options.limitReachedClass)
            ...
            return this.each(function() {
                ...
                function firstInit() {
                    ...
                    if (currentInput.is("textarea")) {
                        ...
                        currentInput.mouseup(function() {
                            if (currentInput.outerWidth() !== currentInput.data("maxlenghtsizex") ||
                ...
                currentInput.on("maxlength.reposition",
                    function() {
                        place(currentInput, maxLengthIndicator);
                    });


                currentInput.on("destroyed",
                    function() {
                        if (maxLengthIndicator) {
                ...
                currentInput.on("input",
                    function() {
                        ...
                        if (options.validate && remaining < 0) {
                            ...
                            manageRemainingVisibility(remaining,
                                currentInput,
                                maxLengthCurrentInput,
                                maxLengthIndicator);
                        }
