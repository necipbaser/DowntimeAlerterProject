            ...
            for (i = 0; i < buttonsArray.length; i++) {
                ...
                for (y = 0; y < btnGroups.length; y++) {
                    ...
                    for (z = 0; z < buttons.length; z++) {
                        ...
                        buttonContainer.text(" " + this.__localize(btnText)).addClass("btn-default btn-sm")
                            .addClass(btnClass);
        ...
        showEditor: function() {
            ...
            if (this.$editor === null) {
                    ...
                    allBtnGroups = allBtnGroups
                        ...
                        .sort(function(a, b) {
                            if (options.reorderButtonGroups.indexOf(a.name) <
                                options.reorderButtonGroups.indexOf(b.name)) return -1;
                            if (options.reorderButtonGroups.indexOf(a.name) >
                                options.reorderButtonGroups.indexOf(b.name)) return 1;
                            return 0;
                        });
                ...
                if (container.is("textarea")) {
                    ...
                    var rawContent =
                            (typeof toMarkdown == "function") ? toMarkdown(container.html()) : container.html(),
                    ...
                    data: [
                        {
                            ...
                            callback: function(e) {
                                ...
                                (prevChar = content.substr(selected.start - 1, 1), !!prevChar &&
                                    prevChar != "\n")) {
                                    e.replaceSelection("\n\n### " + chunk);
