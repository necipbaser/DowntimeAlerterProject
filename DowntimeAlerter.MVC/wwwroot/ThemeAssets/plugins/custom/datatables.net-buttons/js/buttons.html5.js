...
//   https://www.ecma-international.org/news/TC45_current_work/Office%20Open%20XML%20Part%204%20-%20Markup%20Language%20Reference.pdf
    var _excelSpecials = [
        ...
        { match: /^\-?\d+\.\d{2}$/, style: 66 }, // Numbers 2 d.p. without thousands separators
        {
            match: /^\([\d,]+\)$/,
            style: 61,
            fmt: function(d) { return -1 * d.replace(/[\(\)]/g, ""); }
    ...
    DataTable.ext.buttons.copyHtml5 = {
        ...
        action: function(e, dt, button, config) {
            ...
            $(document)
                ...
                .on("copy.buttons-copy cut.buttons-copy",
                    function() {
                        close();
                        that.processing(false);
                    });
    ...
    DataTable.ext.buttons.excelHtml5 = {
        ...
        action: function(e, dt, button, config) {
            ...
            var mergeCells = function(row, colspan) {
                ...
                mergeCells[0].appendChild(_createNode(rels,
                    "mergeCell",
                    {
                        attr: {
            ...
            for (var i = 0, ien = data.header.length; i < ien; i++) {
                cols.appendChild(_createNode(rels,
                    "col",
                    {
                        attr: {
                            min: i + 1,
            ...
            if (config.autoFilter) {
                $("mergeCells", rels).before(_createNode(rels,
                    "autoFilter",
                    {
                        attr: {
                ...
                $("definedNames", workbook).append(_createNode(workbook,
                    "definedName",
                    {
                        attr: {
