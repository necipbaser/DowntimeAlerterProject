        ...
        var ListEventRenderer = /** @class */ (function(_super) {
            ...
            ListEventRenderer.prototype.renderSegHtml = function(seg) {
                ...
                if (eventDef.allDay) {
                    ...
                    if (seg.isStart) {
                        timeHtml = core.htmlEscape(this._getTimeText(eventInstance.range.start,
                            seg.end,
                            false // allDay
                        ));
                    } else if (seg.isEnd) {
                        timeHtml = core.htmlEscape(this._getTimeText(seg.start,
        ...
        */
        var ListView = /** @class */ (function(_super) {
            ...
            function ListView(context, viewSpec, dateProfileGenerator, parentEl) {
                ...
                _this.renderContent = core.memoizeRendering(eventRenderer.renderSegs.bind(eventRenderer),
                    eventRenderer.unrender.bind(eventRenderer));
                _this.el.classList.add("fc-list-view");
                var listViewClassNames =
                    (_this.theme.getClass("listView") || "").split(" "); // wish we didn't have to do this
            ...
            ListView.prototype._eventStoreToSegs = function(eventStore, eventUiBases, dayRanges) {
                return this.eventRangesToSegs(core.sliceEventStore(eventStore,
                        eventUiBases,
                        this.props.dateProfile.activeRange,
                        this.nextDayThreshold).fg,
                    dayRanges);
            };
